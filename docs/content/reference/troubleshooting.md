...
Most of these come down to network reality or how comick serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

comick rate-limits like any public site. comick already paces
...
Where a surface is gated, comick reads a cookie or token you supply
...
`comick`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what comick actually did
